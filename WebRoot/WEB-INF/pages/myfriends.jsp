 		...
 		<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <h3><i class="fa fa-steam"></i>  My Friend</h3>
                        </div>
                    ...
                    <thead>
                     ...
                     <c:forEach var="re"   items="${friends}">
                     <tbody>
                     <tr>
                     	<td><img src="${re.getAvatarMediumUrl()}"></td>
                    	 <td>${re.getSteamId64()}</td>
                    	 <td>${re.getNickname()}</td>
                    	 <td>${re.getRealName()}</td>
                    	 <td>${re.getStateMessage()}</td>
                    </tr>
                    </tbody>
                     </c:forEach>
