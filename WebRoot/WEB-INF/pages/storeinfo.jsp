...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                        	<a href="blank.html"><i class="fa fa-key"></i> 关于系统</a>
                        </li>
                        </ul>
                            <!-- /.nav-second-level -->
                        </li>
     ...
     <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-shopping-cart fa-fw"></i>商店信息</h1>
                </div>
            </div>
   ...
   <div class="well well-sm">
     <table class="table table-bordered table-hover table-striped"  text-align="center">
				...
				<c:forEach var="re" items="${result.getStoreinfoCollocation()}">
					  <tbody>
						  <tr>
							  <td>${re.getId()}</td>
							  <td>${re.getName()}</td>
